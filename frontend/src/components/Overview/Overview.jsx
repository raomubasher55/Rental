...
const Overview = () => {
    const data = [
        ...
        { name: 'Jul', total: Math.floor(Math.random() * 5000) },
        { name: 'Aug', total: Math.floor(Math.random() * 5000) },
        { name: 'Sep', total: Math.floor(Math.random() * 5000) },
        { name: 'Oct', total: Math.floor(Math.random() * 5000) },
        { name: 'Nov', total: Math.floor(Math.random() * 5000) },
        { name: 'Dec', total: Math.floor(Math.random() * 5000) },
      ]
    return (
        <div>
